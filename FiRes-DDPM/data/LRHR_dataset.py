...
class LRHRDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        masks = tifffile.imread(self.poly_path[index])
        ...
        if self.need_LR:
            ...
            img_LR, img_SR, img_HR, pre_fire_img, daymet_img, lulc_img, masks = transformed_data
            if self.split == "val":
                return {
                    "LR": img_LR,
                    "HR": img_HR,
            ...
            img_SR, img_HR, pre_fire_img, daymet_img, lulc_img, masks = transformed_data
            return {
                "HR": img_HR,
                "SR": img_SR,
                "Pre_Fire": pre_fire_img,
